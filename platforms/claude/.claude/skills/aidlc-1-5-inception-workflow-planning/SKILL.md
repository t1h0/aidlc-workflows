---
name: aidlc-1-5-inception-workflow-planning
description: AI-DLC phase 1 (Inception) - stage 5 (Workflow Planning). Focuses on determining which phases to execute and creating a comprehensive execution plan.
---
...
**See `Adaptive Depth` for adaptive depth explanation**
