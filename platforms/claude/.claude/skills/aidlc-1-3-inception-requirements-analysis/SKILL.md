---
name: aidlc-1-3-inception-requirements-analysis
description: AI-DLC phase 1 (Inception) - stage 3 (Requirements Analysis). Focuses on analyzing and documenting detailed requirements based on user stories and initial request analysis.
---
...
**Refer to `Adaptive Depth` for adaptive depth explanation**
...
2. **Deferred Rule Loading**: For each extension the user opted IN, load the full skill now. For extensions the user opted OUT, do NOT load the full skill.
