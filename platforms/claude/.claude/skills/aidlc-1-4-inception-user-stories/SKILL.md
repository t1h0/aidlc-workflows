---
name: aidlc-1-4-inception-user-stories
description: AI-DLC phase 1 (Inception) - stage 4 (User Stories). Focuses on converting requirements into user-centered stories with acceptance criteria.
---
...
**See the `Question Format Guide` for question formatting rules**
